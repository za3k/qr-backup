...
Common files to back up are small, important records, and small secret files. Examples include: a diary, an address book, financial records, medical records, prose you've written such as short stories, computer programs you've written, an ssh or gpg cryptographic key, or a cryptocurrency (bitcoin) wallet.
